...
class Motors:
    ...
    def fwd(self, speed=180):
        self.pin1.write_analog(speed) # full forward
        self.pin2.write_analog(speed)   # full forward    
        
    # empty functions for the other directions
    def back(self, speed=180):
        pass
    
    def left(self, speed=180):
        pass
    
    def right(self, speed=180):
        pass
...
if __name__ == "__main__":  # only run this code if this file is run directly      
    ...
    my_motors.fwd(1023)  # full speed ahead??
